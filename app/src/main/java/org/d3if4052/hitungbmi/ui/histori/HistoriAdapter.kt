...
import org.d3if4052.hitungbmi.R
import org.d3if4052.hitungbmi.data.HitungBmi
import org.d3if4052.hitungbmi.databinding.ItemHistoriBinding
import org.d3if4052.hitungbmi.db.BmiEntity
    ...
    class ViewHolder(
        ...
        fun bind(item: BmiEntity) = with(binding) {
            ...
            tinggiTextView.text = root.context.getString(R.string.tinggi_x,
                item.tinggi)
            val stringRes = if (item.isMale)
                R.string.pria else R.string.wanita
